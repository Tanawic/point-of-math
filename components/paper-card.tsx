  ...
  return (
    <div className="border-l-2 border-ink bg-white pl-5 pr-4 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4 hover:border-l-[3px] transition-[border]">
      <div className="flex-1 min-w-0">
        <h3 className="text-[15px] font-medium text-ink leading-snug">{title}</h3>
        <div className="mt-2 flex items-center flex-wrap gap-2">
          <span className="text-[10px] uppercase tracking-widest border border-rule text-muted px-2 py-[2px]">
            {competition}
          </span>
          {year && (
            <span className="text-[10px] uppercase tracking-widest border border-rule text-muted px-2 py-[2px]">
